...
def map_page():
    ...
    for contrat in contrats_query.yield_per(50):
        ...
        contrat_data.append({
            ...
            "nom_site": contrat.sites_cen[0].site_cen.nom_site if contrat.sites_cen else "Non spécifié",
            "code_site": contrat.sites_cen[0].site_cen.code_site if contrat.sites_cen else "Non spécifié",
